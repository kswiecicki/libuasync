...
/* Maps 'lookup' future entry data to the 'set_state' future entry data */
static void
		...
		struct future_context *memcpy_value_ctx, void *arg)
{
	...
	/* We will not copy more data that buffer can fit */
...
/*
 * Maps the 'entry_init' future entry data to the 'memcpy_value' future entry
 * data.
 */
static void
